                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col items-center text-center">
                                    <h1 className="text-2xl font-bold">
                                        Welcome to <span className=" text-primary">AgentFlow</span>
                                    </h1>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <Button onClick={onContinueWithGithub} variant="outline" type="button" className="w-full">
                                    ...
                                    <Button onClick={onContinueWithGoogle} variant="outline" type="button" className="w-full">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                            <path
